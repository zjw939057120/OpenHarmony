...
printf("enet_init CHECKSUM_BY_HARDWARE\n");
                enet_init_status =
                    enet_init(ENET_10M_HALFDUPLEX, ENET_AUTOCHECKSUM_DROP_FAILFRAMES, ENET_BROADCAST_FRAMES_PASS);
#else
printf("enet_init NO_CHECKSUM_BY_HARDWARE\n");
                enet_init_status =
                    enet_init(ENET_10M_HALFDUPLEX, ENET_NO_AUTOCHECKSUM, ENET_BROADCAST_FRAMES_PASS);
#endif
            }
...
void enet_adapter_init(net_state_callBack callBack)
{
    ...
    osThreadAttr_t attr1 = {
        ...
        .cb_mem = NULL, 
        .stack_mem = NULL, 
        .stack_size = DHCP_TASK_STACK_SIZE, 
        .priority = DHCP_TASK_PRIORITY};
